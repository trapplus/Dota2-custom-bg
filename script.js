...
function createGalleryItem(background) {
    ...
    const repoBase = 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main';
    const imagePath = `${repoBase}/complited-bg/${background.folder}/img.jpg`;
    const downloadPath = `https://github.com/YOUR_USERNAME/YOUR_REPO/raw/main/complited-bg/${background.folder}/pak03_dir.vpk`;
